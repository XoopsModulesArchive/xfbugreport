...
$GLOBALS['xoopsOption']['template_main'] = 'xfmod_bugindex.html';
    include('../../header.php');
    ...
    $xoopsTpl->assign('helptitel', _XF_BR_HELPTITEL);
    $xoopsTpl->assign('helptext1', _XF_BR_HELPTEXT1);
    $xoopsTpl->assign('choicetitel', _XF_BR_CHOICE);
    $xoopsTpl->assign('choice', _XF_BR_CHOICEBOX);
